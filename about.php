    ...
    <div class="content-container">
        ...
        <div class="about-container">
            <div>
                ...
                <p>Since 2021 I have been part of the <a href="scs_scheme.html">SCS Scheme</a>, expanding my skills in web development with the hope of becoming a full time developer.</p>
            </div>
        </div>
        ...
        <div class="contact-container" id="contact">
            <div>
                <form class="newsletter-signup" action="#">
                    <label for="email-name"></label><input type="text" id="email-name" placeholder="Your Name"><br>
                    <label for="email-address"></label><input type="email" id="email-address" placeholder="Your Email"><br>
                    <label for="phone-number"></label><input type="number" id="phone-number" placeholder="Phone number (optional)"><br>
                    <label for="email-subject"></label><input type="text" id="email-subject" placeholder="Email Subject (optional)"><br>
                    <label for="email-message"></label><textarea id="email-message"></textarea><br>
